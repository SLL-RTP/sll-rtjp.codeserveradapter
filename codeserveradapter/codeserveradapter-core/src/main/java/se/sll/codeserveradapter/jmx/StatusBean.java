 ...
 */
package se.sll.codeserveradapter.jmx;
...
@Component
@ManagedResource(objectName = "se.sll.codeserveradapter:name=StatusBean", description="Status information")
public class StatusBean {
    ...
    public int getTotalIndexSize() {
        return hsaMappingService.getCurrentIndex().size();
    }
